...
/**
 * Class ViewsFlickrPhotosetsGetListQuery.
 */
class ViewsFlickrPhotosetsGetListQuery extends views_plugin_query {
  ...
  function build(&$view) {
    ...
    $view->build_info['views_flickr_request']->addArgument('method', 'flickr.photosets.getList');
  ...
  function execute(&$view) {
    ...
    if (isset($results->photosets->total)) {
      $view->total_rows = $results->photosets->total;
